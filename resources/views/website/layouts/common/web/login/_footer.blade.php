    ...
    <div class="container">
      <div class="row">
        ...
        <!--<div class="col-lg-3 col-md-6">
          ...
          <ul class="list-unstyled">
            <li>
              <a href="#"><span style="font-weight: 800"> </span>Aliquam Expedita
                Magni</a>
            </li>
            <li>
              <a href="#"><span style="font-weight: 800"> </span>Standard Blog Post</a>
            </li>
            <li>
              <a href="#"><span style="font-weight: 800"> </span>Consectetur
                Adipisicing Elit</a>
            </li>
            <li>
              <a href="#"><span style="font-weight: 800"> </span>Ratione Eligendi
                Tempora</a>
            </li>
            <li>
              <a href="#"><span style="font-weight: 800"> </span>Lorem Ipsum Dolor
                Sit</a>
            </li>
          </ul>
        </div>-->
        <div class="col-lg-3 col-md-6" style="float:right !important;">
