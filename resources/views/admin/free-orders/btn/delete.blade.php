    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark white">
                <h5 class="text-white modal-title" id="exampleModalLabel">{{'Delete '. $order?->slug }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('freeOrders.destroy', $order->id)}}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <h3 class="form-group ml-5 p-1">
                            Are You Sure To Delete <span class="text-danger">{{$order?->slug}}</span>
                        </h3>
                    </div>
