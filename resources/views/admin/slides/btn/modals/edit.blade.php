    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark white">
                <h5 class="text-white modal-title" id="exampleModalLabel">{{'Edit '. $slide?->name }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('slides.update', $slide->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <img class="img-thumbnail img-fluid" id="image-preview" src="{{$slide->ImagePath()}}" alt="{{$slide->name}}">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12 ">
                            <div class="card" style="height: 243.2px; width:420px !important;">
                                <div class="card-header">
                                    <label for="notes" class="cursor-pointer card-title">Notes</label>
                                </div>
                                <div class="card-body center">
                                    <fieldset class="form-group">
                                        <textarea class="form-control" name="notes" id="notes" rows="3">{!! $slide->notes !!}</textarea>
                                    </fieldset>
                                    @error('notes')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                    ...
                    <div class="p-1 form-group">
                        ...
                        <select name="status" class="p-1 form-control">
                            <option selected disabled>Select <span class="text-primary">{{$slide->name}}</span>
                                Status...</option>
