<div class="modal fade" id="create_orderTurnaroundTime" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('orderServiceTime.store') }}" method="POST">
                    @csrf
                    <!-- Start Name -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required name="notes" id="notes"
                            value="">
                        @error('notes')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
