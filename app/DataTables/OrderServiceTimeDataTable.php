...
class OrderServiceTimeDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (OrderServiceTime $orderServiceTime) {
                return view('admin.orderTurnaroundTime.btn.actions', compact('orderServiceTime'));
            })
            ->editColumn('status', function (OrderServiceTime $orderServiceTime) {
                return $orderServiceTime->statusWithLabel();
            })
            ->editColumn('created_at', function (OrderServiceTime $orderServiceTime) {
                return $orderServiceTime->created_at->format('Y-m-d');
            })
            ->editColumn('updated_at', function (OrderServiceTime $orderServiceTime) {
                return $orderServiceTime->created_at->format('Y-m-d');
            })
     ...
     */
    public function query(OrderServiceTime $model): QueryBuilder
    {
    ...
    public function html() {
        return $this->builder()
            ->setTableId('order-service-time-table')
    ...
    protected function getColumns() {
        return [
            ...
            ['name' => 'notes', 'data' => 'notes', 'title' => 'Note',],
...
//            ['name' => 'updated_at', 'data' => 'updated_at', 'title' => 'Update At', 'orderable' => false, 'searchable' => false,],
    ...
    {
        return 'OrderServiceTime_' . date('YmdHis');
    }
}